...
class SettingsViewController: UITableViewController {
		...
		if section == 0 {
			...
			if let year = components.year {
				...
				if year == startYear {
					...
					copyrightText = "© \(startYear) Timely Design. Textor v\(version) (build \(build))"

				} else {

					copyrightText = "© \(startYear)-\(year) Timely Design. Textor v\(version) (build \(build))"
	...
	override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		...
		case 0:
			...
			case 0:
				// Timely Design
				url = "https://timelydesign.org"
			case 1:
				// GitHub
				url = "https://github.com/therea1cando"
			case 2:
				// Twitter
				url = "https://twitter.com/ConnorL46162918"
			case 3:
				// Contact Us
				url = nil
	...
	func configuredMailComposeViewController() -> MFMailComposeViewController {
		...
		mailComposerVC.setToRecipients(["LoveConnor2005@gmail.com"])
